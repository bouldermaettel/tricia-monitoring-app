...
export function UserManagement() {
    ...
    function onEditDisplayNameChange(userId, currentDisplayName, currentAcronym, currentRole, currentActive, value) {
    ...
    function onEditAcronymChange(userId, currentDisplayName, currentAcronym, currentRole, currentActive, value) {
        const previous = editing[userId];
        setEditing((prev) => ({
            ...prev,
            [userId]: {
    ...
    function onEditRoleChange(userId, currentDisplayName, currentAcronym, currentRole, value, currentActive) {
        const previous = editing[userId];
        setEditing((prev) => ({
            ...prev,
            [userId]: {
    ...
    function onEditActiveChange(userId, currentDisplayName, currentAcronym, currentRole, checked, currentActive) {
        const previous = editing[userId];
        setEditing((prev) => ({
            ...prev,
            [userId]: {
    ...
    function onEditPasswordChange(userId, currentDisplayName, currentAcronym, currentRole, currentActive, value) {
        const previous = editing[userId];
        setEditing((prev) => ({
            ...prev,
            [userId]: {
    ...
    async function onSaveUser(userId, originalDisplayName, originalAcronym, originalRole, originalActive) {
        ...
        if (!payload.display_name && !payload.acronym && !payload.role && payload.is_active === undefined && !payload.password)
            return;
