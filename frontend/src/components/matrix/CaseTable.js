...
export function CaseTable({ items, onMarkReviewed, onToggleExcluded, onSetCategory, onAddComment, onEditCase, onDeleteCase, onExportStateChange }) {
    ...
    return (_jsxs("div", { className: "rounded-xl border border-stone-200 bg-white overflow-hidden", children: [_jsxs("div", { className: "px-4 py-3 border-b border-stone-200 bg-stone-50 flex items-center justify-between gap-3", children: [_jsxs("span", { className: "text-xs text-stone-500", children: ["Showing ", filteredItems.length, " of ", items.length, " cases"] }), _jsxs("div", { className: "flex items-center gap-2", children: [onDeleteCase && (_jsx(_Fragment, {})), _jsx("button", { onClick: () => {
                                    ...
                                    setDateFilterTo('');
                                                ...
                                                ? 'text-center'
                                                : 'text-left'}`, children: columnId === 'date_reported' ? (_jsxs("button", { type: "button", onClick: () => setShowDateColumnPicker((previous) => !previous), className: "inline-flex items-center gap-1 rounded px-1 py-0.5 hover:bg-stone-200 text-xs font-semibold uppercase tracking-wide", title: "Toggle date range picker", children: [COLUMN_LABELS[columnId], _jsx("span", { className: "text-[10px] text-stone-400", children: showDateColumnPicker ? '▲' : '▼' })] })) : (COLUMN_LABELS[columnId]) }, columnId)))] }), _jsxs("tr", { className: "border-b border-stone-200 bg-white", children: [onDeleteCase && (_jsx("th", { className: "px-3 py-2 text-center", children: _jsx("input", { type: "checkbox", checked: allVisibleSelected, onChange: (e) => (e.target.checked ? selectAllVisible() : deselectAll()), "aria-label": "select-all-visible-cases" }) })), columns.map((columnId) => (_jsx("th", { className: "px-3 py-2", children: columnId === 'category_code' ? (_jsxs("select", { value: filters.category_code, onChange: (e) => setFilters((previous) => ({ ...previous, category_code: e.target.value })), className: "w-full text-xs border border-stone-200 rounded px-2 py-1 bg-white", children: [_jsx("option", { value: "", children: "All" }), categoryOptions.map((value) => (_jsx("option", { value: value, children: value }, value)))] })) : columnId === 'is_excluded' || columnId === 'is_reviewed' ? (_jsxs("select", { value: filters[columnId], onChange: (e) => setFilters((previous) => ({ ...previous, [columnId]: e.target.value })), className: "w-full text-xs border border-stone-200 rounded px-2 py-1 bg-white", children: [_jsx("option", { value: "", children: "All" }), _jsx("option", { value: "yes", children: "Yes" }), _jsx("option", { value: "no", children: "No" })] })) : columnId === 'actions' ? (_jsxs("select", { value: filters.actions, onChange: (e) => setFilters((previous) => ({ ...previous, actions: e.target.value })), className: "w-full text-xs border border-stone-200 rounded px-2 py-1 bg-white", children: [_jsx("option", { value: "", children: "All" }), _jsx("option", { value: "edited", children: "Edited" }), _jsx("option", { value: "not_edited", children: "Not edited" })] })) : columnId === 'date_reported' ? (_jsx("div", { className: "space-y-1", children: showDateColumnPicker ? (_jsxs(_Fragment, { children: [_jsx("input", { type: "date", value: dateFilterFrom, onChange: (e) => setDateFilterFrom(e.target.value), className: "w-full text-xs border border-stone-200 rounded px-2 py-1 bg-white", title: "Date Reported from" }), _jsx("input", { type: "date", value: dateFilterTo, onChange: (e) => setDateFilterTo(e.target.value), className: "w-full text-xs border border-stone-200 rounded px-2 py-1 bg-white", title: "Date Reported to" })] })) : (_jsx("button", { type: "button", onClick: () => setShowDateColumnPicker(true), className: "w-full text-left text-[11px] text-stone-500 border border-dashed border-stone-300 rounded px-2 py-1 hover:bg-stone-50", children: "Click Date Reported above" })) })) : (_jsx("input", { value: filters[columnId], onChange: (e) => setFilters((previous) => ({ ...previous, [columnId]: e.target.value })), placeholder: "Filter...", className: "w-full text-xs border border-stone-200 rounded px-2 py-1" })) }, columnId)))] })] }), _jsxs("tbody", { children: [filteredItems.map((item, itemIndex) => {
